...
## 考核任务源代码在交通灯源代码中，结果已放入result.avi中。

# 第四周：本周主要学习的是ROS2和Gazebo
## 本周笔记有二：《ROS2》,《Gazebo》
### 在ros2笔记中，根据考核的内容，先学习了ros2的基本空间结构以及功能包的管理方法，大体掌握了ros2的整体逻辑，其次，通过学习ros2的通信机制，初步了解了话题，服务，参数，动作这四种通信方式，接着，学习了如何用c++编写节点。之后，详细学习了话题，服务与参数的具体内容，紧接着，学习了rivz可视化，这块的内容在Gazebo中也有提及。
### 在gazebo笔记中，根据考核内容，先通过简要的介绍了解了gazebo，类似于一个实践的平台，通过gazebo，可以实现对机器人的操作，然后，了解了gazebo的基础操作，同时又了解了关键文件.world和.stf。四和五则是对机器人进行一些基础操作，六承接了ros2中对rivz的学习实现了ros2和gazebo的结合。
## 本周笔记链接和第一，二周一样，在视觉文件中
